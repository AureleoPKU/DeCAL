...
Usage:
    python3 -m lerobot.policies.DeCAL.cosmos_tokenizer.video_cli \
...
from lerobot.policies.DeCAL.cosmos_tokenizer.networks import TokenizerConfigs
from lerobot.policies.DeCAL.cosmos_tokenizer.utils import (
    get_filepaths,
    get_output_filepath,
    read_video,
    resize_video,
...
from lerobot.policies.DeCAL.cosmos_tokenizer.video_lib import CausalVideoTokenizer
